    ...
    <div class="page-content">
        <div class="row">
            ...
            <div class="col-md-6 text-end">
                <a href="{{ route('cash.create') }}" class="btn btn-success">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('cash.edit',$row->ID) }}" class="btn btn-square-45 btn-secondary">
                                        <i class="fas fa-pen-clip"></i>
                                    </a>
                                </td>
                                <td class="text-center">
                                    <form id="formStatus{{$row->ID}}" action="{{ route('cash.destroy',$row->ID) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        {{ method_field('DELETE') }}
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <h4 class="modal-body">¿Está seguro de modificar el estado de la caja?</h4>
                <label>Se cambiara el estado de la caja seleccionada</label>
            </div>
