...
<div class="page-wrapper">
    <div class="page-content">
        <div class="row">
            <div class="col-md-6"> <h3>Editar Caja</h3> </div>
            ...
            <div class="col-xl-8 mx-auto">
                <div class="card border-top border-0 border-4 border-dark"> <!-- Tarjeta -->
                    <div class="card-header py-3 "> <!-- Cabecera de la tarjeta -->
                        <h5>Aqui podra editar los datos de la caja seleccionada</h5>
                    </div>
                    <div class="card-body py-3 px-5"> <!-- Cuerpo de la tarjeta -->
                        <form id="formCash" action="{{ route('cash.update',$cash->ID) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }}    
                            <div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" value="{{ $cash->codigo }}" readonly>
                                    </div>
                                    <div class="col-md-6">
                                        <h6>Alias de caja:</h6>
                                        <input type="text" class="form-control" name="alias" value="{{ $cash->nombre }}">
                                        @error('alias')
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <h4 class="modal-body text-primary">¿Está seguro de modificar datos de la caja?</h4>
            </div>
