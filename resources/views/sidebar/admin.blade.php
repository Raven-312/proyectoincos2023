            ...
            <div class="page-sidebar sidebar horizontal-bar">
                <div class="page-sidebar-inner">
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="{{ route('menu') }}"><span class="menu-icon icon-speedometer"></span><p>Dashboard</p></a></li>
                        <li><a href="{{ route('user.index') }}"><span class="menu-icon icon-user"></span><p>Usuarios</p></a></li>
                        ...
                        <li class="droplink"><a href="#"><span class="menu-icon icon-briefcase"></span><p>UI Kits</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="{{ route('user.index') }}">Alerts</a></li>
