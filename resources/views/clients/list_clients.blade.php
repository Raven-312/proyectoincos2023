            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3 row">
                        <div class="col-4">
                            <label for="ciClient"><h5>CI/NIT:<h5></label>
                        </div>
                        <div class="col-8 mb-2">
                            <input type="text" class="form-control" id="ciClient" autofocus>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 row">
                        ...
                        <div class="col-8 mb-2">
                            <input type="text" class="form-control" id="fullnameClient" name="" readonly>
                            <input type="text" class="form-control" id="inputIDClient" name="" hidden>
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('sale.index',$row->ID) }}" type="button" class="btn btn-square-50 btn-info">
                                        <i class="fas fa-cart-plus"></i>
                                    </a>
                                    @else
                                    <a href="{{ route('sale.index',$row->ID) }}" type="button" class="btn btn-square-50 btn-danger">
                                        <i class="fas fa-shop-slash"></i>
                                    </a>
                                    @endif
                                </td>
                                <td class="text-center">
                                    <a href="{{ route('client.edit',$row->ID) }}" type="button" class="btn btn-square-45 btn-secondary">
                                        <i class="fas fa-pen-clip"> </i>
                                    </a>
                                    <form id="formStatus{{$row->ID}}" action="{{ route('client.destroy',$row->ID) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        {{ method_field('DELETE') }}
                                        @if(verificarEstado($row->estado))
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <h4 class="modal-body">¿Esta seguro de modificar el estado del Cliente?</h4>
                <label>Se cambiara el estado del cliente seleccionado</label>
            </div>
...
@section('scripts')
    ...
    <script>
        ...
        document.getElementById('btnSearch').onclick = function(){
            ...
            let ci = document.getElementById('ciClient').value;
            if(ci == ""){
                return ;
            }
            $.ajax({
            ...
            data: {
                ...
                if(res.length>0){
                    document.getElementById('fullnameClient').value = res[0].nombres+" "+res[0].apellidos;
                    document.getElementById('inputIDClient').value = res[0].ID;
                    document.getElementById('btnGlobalSale').setAttribute('href','sale/'+res[0].ID);
                }else{
                    document.getElementById('fullnameClient').value = "No encontrado!!!";
                }
            },statusCode: {
