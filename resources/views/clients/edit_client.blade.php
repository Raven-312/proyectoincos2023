...
<div class="page-wrapper">
    <div class="page-content">
        <div class="row">
            <div class="col-md-6"> <h3>Editar Cliente</h3> </div>
            ...
            <div class="col-xl-8 mx-auto">
                <div class="card border-top border-0 border-4 border-dark"> <!-- Tarjeta -->
                    <div class="card-header py-3"> <!-- Cabecera de la tarjeta -->
                        <h5>Aqui podra modificar los datos del cliente seleccionado</h5>
                    </div>
                    <div class="card-body py-3 px-5"> <!-- Cuerpo de la tarjeta -->
                        <form id="formClient" action="{{ route('client.update',$client->ID) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PATCH') }}
                        <div>   
                        <h5><i class="fas fa-address-card"></i> Datos Personales:</h5>
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" value="{{ $client->CI }}" readonly>
                                </div>
                                <div class="col-md-4">
                                    <h6>Nombres:</h6>
                                    <input type="text" class="form-control" name="name" value="{{ $client->nombres }}">
                                    @error('name')
                                ...
                                <div class="col-md-4">
                                    <h6>Apellidos:</h6>
                                    <input type="text" class="form-control" name="lastname" value="{{ $client->apellidos }}">
                                    @error('lastname')
									<div class="alert alert-danger border-0 py-0 bg-danger">
										<div class="text-white">{{ $message }}</div>
									</div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="phone" value="{{ $client->contacto }}">
                                    @error('phone')
									<div class="alert alert-danger border-0 py-0 bg-danger">
										<div class="text-white">{{ $message }}</div>
									</div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="email" class="form-control" name="email" value="{{ $client->correo }}">
                                    @error('email')
									<div class="alert alert-danger border-0 py-0 bg-danger">
										<div class="text-white">{{ $message }}</div>
									</div>
                                ...
                                <div class="col-md-4">
                                    <h6>Dirección:</h6>
                                    <input type="text" class="form-control" name="address" value="{{ $client->direccion }}">
                                    @error('address')
									<div class="alert alert-danger border-0 py-0 bg-danger">
										<div class="text-white">{{ $message }}</div>
									</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <h4 class="modal-body text-primary">¿Esta seguro de modificar datos del cliente?</h4>
            </div>
