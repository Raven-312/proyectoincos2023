...
<div class="page-wrapper">
    <div class="page-content">
        <div class="row">
            <div class="col-md-6"> <h3>Editar Categoría</h3> </div>
            ...
            <div class="col-xl-5 mx-auto">
                <div class="card border-top border-0 border-4 border-dark"> <!-- Tarjeta -->
                    <div class="card-header py-3"> <!-- Cabecera de la tarjeta -->
                        <h5>Aqui podra modificar los datos de la categoría seleccionada</h5>
                    </div>
                    <div class="card-body py-3 px-5"> <!-- Cuerpo de la tarjeta -->
                        <form id="formCategory" action="{{ route('category.update',$category->ID) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }}    
                            <div>
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    ...
                                    <button class="btn btn-secondary" type="reset">
                                        <i class="fas fa-pen"></i> Restaurar
                                    </button>
                                </div>
                            </div>
                        </form>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <h4 class="modal-body text-primary">¿Está seguro de modificar datos de la Categoría?</h4>
            </div>
