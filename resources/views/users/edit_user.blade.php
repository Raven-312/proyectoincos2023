...
<div class="page-wrapper">
    <div class="page-content">
        <div class="row">
            <div class="col-md-6"> <h3>Editar Usuario</h3> </div>
            ...
            <div class="col-xl-8 mx-auto">
                <div class="card border-top border-0 border-4 border-dark"> <!-- Tarjeta -->
                    <div class="card-header py-3"> <!-- Cabecera de la tarjeta -->
                        <h5>Aqui podra modificar el formulario con los datos del usuario seleccionado</h5>
                    </div>
                        ...
                        {{ method_field('PATCH') }}
                            <div>   
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <h6>Nombres:</h6>
                                        <input type="text" class="form-control" name="name" value="{{ $user->nombres }}" required>
                                        @error('name')
                                    ...
                                    <div class="col-md-6">
                                        <h6>Apellidos:</h6>
                                        <input type="text" class="form-control" name="lastname" value="{{ $user->apellidos }}" required>
                                        @error('lastname')
										<div class="alert alert-danger border-0 py-0 bg-danger">
											<div class="text-white">{{ $message }}</div>
										</div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <h6 class="text-center">Foto Actual:</h6>
                            ...
                            <div>
                                <h5><i class="fas fa-key"></i> Acceso:</h5>
                                <div class="row">
                                    <div class="col-md-4">
                                        <?php
                                            $Adm = "";
                                        ...
                                        <select class="form-select" name="access">
                                            <option value="root" <?php echo $Adm ?>>Super</option>
                                            <option value="Vendedor" <?php echo $Ven ?>>Vendedor</option> 
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        <h6> Caja:</h6>
                                        <select class="form-select" name="cash" required>
                                        @foreach($list as $row)
                                            @if($row->ID == $user->caja)
                                            <option value="{{ $row->ID }}" selected>{{ $row->codigo.' ('.$row->nombre.')' }}</option>
                                            @else
                            ...
                            <div>
                                <h5><i class="fas fa-fingerprint"></i> Cuenta:</h5>
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        @enderror
                                        <small>(No es necesario modificar este dato)</small>
                                    </div>
                                    <div class="col-md-4">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <h4 class="modal-body text-primary">¿Está seguro de modificar datos del usuario?</h4>
            </div>
