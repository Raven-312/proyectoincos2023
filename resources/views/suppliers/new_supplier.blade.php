...
<div class="page-wrapper">
    <div class="page-content">
        <div class="row">
            <div class="col-md-6"> <h3>Nuevo Proveedor</h3> </div>
            ...
            <div class="col-xl-8 mx-auto">
                <div class="card border-top border-0 border-4 border-dark"> <!-- Tarjeta -->
                    <div class="card-header py-3"> <!-- Cabecera de la tarjeta -->
                        <h5>Aqui podra llenar el formulario con los datos del nuevo proveedor</h5>
                    </div>
                    <div class="card-body py-3 px-5"> <!-- Cuerpo de la tarjeta -->
                        <form id="formSupplier" action="{{ route('supplier.store') }}" method="POST" enctype="multipart/form-data">
                            <div>
                                @csrf
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <h4 class="modal-body text-primary">¿Esta seguro de agregar al nuevo Proveedor?</h4>
            </div>
